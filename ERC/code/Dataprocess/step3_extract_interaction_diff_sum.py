...
# =========================================================
def main():
    print(f"=== [Step 3] Interaction (Diff, Sum) Features Extraction ===")
    
    if not os.path.exists(EXISTING_XLSX):
        print(f"[ERROR] Step 1,2 File not found: {EXISTING_XLSX}")
        return
    ...
    print("Preparing interaction timeseries (Diff, Sum)...")
    for pm_path in pm_files:
        ...
        try:
            ...
            for pct in PCTS:
                ...
                value_vars = ['Diff_Num_0.3um_VOC', 'Sum_Num_0.3um_VOC']
    ...
    print(f"\n[tsfresh] Extracting features for Diff & Sum...")
